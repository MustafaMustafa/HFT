...
StMcPxlSensorHitCollection::StMcPxlSensorHitCollection() { /* noop */ }
...
StMcPxlSensorHitCollection::hits() const { return mHits; }

StSPtrVecMcPxlHit&
StMcPxlSensorHitCollection::hits() { return mHits; }
