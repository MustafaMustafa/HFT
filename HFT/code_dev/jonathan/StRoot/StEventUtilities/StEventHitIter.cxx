...
//________________________________________________________________________________
//_______PXL_______PXL_______PXL_______PXL_______PXL_______PXL_______PXL_______TPC
//________________________________________________________________________________
//..............................................................................
class StPxlHitIter : public StHitIter {
public:
  StPxlHitIter();
  //    		StPxlHitIter(StDetectorId id){fDetectorId=id;}
...
{
  return (const TObject*)((StPxlHitCollection*)fCont)->hits().at(idx);
}
//________________________________________________________________________________
int StPxlHitIter::GetSize () const
{
  return ((StPxlHitCollection*)fCont)->hits().size();
}
//________________________________________________________________________________
//_______IST_______IST_______IST_______IST_______IST_______IST_______IST_______TPC
//________________________________________________________________________________
//..............................................................................
class StIstHitIter : public StHitIter {
public:
  //	StIstHitIter(StDetectorId id){fDetectorId=id;}
  StIstHitIter();
...
{
  return (const TObject*)((StIstHitCollection*)fCont)->hits().at(idx);
}
//________________________________________________________________________________
int StIstHitIter::GetSize () const
{
  return ((StIstHitCollection*)fCont)->hits().size();
}
//________________________________________________________________________________
