...
//______________________________________________________________________________
StPxlHitCollection* StEvent::pxlHitCollection()
{
    StPxlHitCollection *hits = 0;
    _lookup(hits, mContent);
    return hits;
}

//______________________________________________________________________________
const StPxlHitCollection* StEvent::pxlHitCollection() const
{
    StPxlHitCollection *hits = 0;
    _lookup(hits, mContent);
    return hits;
...
//______________________________________________________________________________
StIstHitCollection* StEvent::istHitCollection()
{
    StIstHitCollection *hits = 0;
    _lookup(hits, mContent);
    return hits;
}

//______________________________________________________________________________
const StIstHitCollection* StEvent::istHitCollection() const
{
    StIstHitCollection *hits = 0;
    _lookup(hits, mContent);
    return hits;
...
void
StEvent::setPixelHitCollection(StPxlHitCollection* val)
{
    _lookupAndSet(val, mContent);
}
