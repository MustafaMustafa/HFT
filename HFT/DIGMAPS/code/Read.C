void Read(TString input_name="input.txt",TString output_name="output.txt")
{
  ...
  DIGMAPS myDIGMAPS2("nameDIGMAPS","titleDIGMAPS","./",input_name.Data(),"./",output_name.Data(),"plot");
