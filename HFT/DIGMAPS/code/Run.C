void Run(TString input_name="input.txt",TString output_name="output.txt")
{
  ...
  DIGMAPS myDIGMAPS("nameDIGMAPS","titleDIGMAPS","./",input_name.Data(),"./",output_name.Data(),"foresee");
