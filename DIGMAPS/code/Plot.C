{
  ...
  // pitch 10, model Lor -->  0
  // pitch 10, model Gaus -->  1
  // pitch 10, model LorGaus --> 2 ++ sauf repartition entre les couronnes
  // pitch 10, model LorlorGaus --> 3 ++ sauf repartition entre les couronnes
  // pitch 10, model LorlorGaus -->  4 -

  // pitch 20, model Lor -->   10
  // pitch 20, model Gaus -->   11
  // pitch 20, model LorGaus -->  12 +++
  // pitch 20, model LorlorGaus -->   13 +++
  // pitch 20, model LorlorGaus --> 14  +

  // pitch 30, model Lor -->  25 
  // pitch 30, model Gaus -->   26
  // pitch 30, model LorGaus -->  27 +++
  // pitch 30, model LorlorGaus --> 28  ++
  // pitch 30, model LorlorGaus -->   29 +++

  // pitch 40, model Lor --> 35  
  // pitch 40, model Gaus -->  36 
  // pitch 40, model LorGaus --> 37  +++
  // pitch 40, model LorlorGaus -->38   +++ sauf plot vs distance
  // pitch 40, model LorlorGaus -->  39 +++ sauf plot vs distance


  // pitch 10, model Lor --> 3
  // pitch 10, model Gaus --> 4
  // pitch 10, model LorGaus --> 5
  // pitch 20, model Lor --> 12
  // pitch 20, model Gaus --> 13
  // pitch 20, model LorGaus --> 14
  // pitch 30, model Lor --> 24
  // pitch 30, model Gaus --> 25
  // pitch 30, model LorGaus --> 26
  // pitch 40, model Lor --> 33
  // pitch 40, model Gaus --> 34
  // pitch 40, model LorGaus --> 35
/*
************************************************************
           List of all configurations
num |Thet|Phi |Pit x X y|epi |Nois|Temp|Nbits|lin|LSB  |gain   |Model|
   0| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.64|   0.64|1    |
   1| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.64|   0.64|2    |
   2| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.64|   0.64|3    |
   3| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.64|   0.64|4    |
   4| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.64|   0.64|4    |
   5| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.60|   0.60|1    |
   6| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.60|   0.60|2    |
   7| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.60|   0.60|3    |
   8| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.60|   0.60|4    |
   9| 0.0| 0.0|10.0X10.0|12.6|10.9|10.0|12   |1  | 0.60|   0.60|4    |
  10| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.64|   0.64|1    |
  11| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.64|   0.64|2    |
  12| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.64|   0.64|3    |
  13| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.64|   0.64|4    |
  14| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.64|   0.64|4    |
  15| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.60|   0.60|1    |
  16| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.60|   0.60|2    |
  17| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.60|   0.60|3    |
  18| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.60|   0.60|4    |
  19| 0.0| 0.0|20.0X20.0|10.8| 9.2|10.0|12   |1  | 0.60|   0.60|4    |
  20| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.64|   0.64|1    |
  21| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.64|   0.64|2    |
  22| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.64|   0.64|3    |
  23| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.64|   0.64|4    |
  24| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.64|   0.64|4    |
  25| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.60|   0.60|1    |
  26| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.60|   0.60|2    |
  27| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.60|   0.60|3    |
  28| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.60|   0.60|4    |
  29| 0.0| 0.0|30.0X30.0| 8.7| 9.4|10.0|12   |1  | 0.60|   0.60|4    |
  30| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.64|   0.64|1    |
  31| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.64|   0.64|2    |
  32| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.64|   0.64|3    |
  33| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.64|   0.64|4    |
  34| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.64|   0.64|4    |
  35| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.60|   0.60|1    |
  36| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.60|   0.60|2    |
  37| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.60|   0.60|3    |
  38| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.60|   0.60|4    |
  39| 0.0| 0.0|40.0X40.0| 7.8| 9.8|10.0|12   |1  | 0.60|   0.60|4    |
num |Thet|Phi |Pit x X y|epi |Nois|Temp|Nbits|lin|LSB  |gain   |Model|
...
*/
  ...
  // pitch 10, model Lor --> 4
  // pitch 10, model Gaus --> 5
  // pitch 10, model LorGaus --> 6
  // pitch 10, model LorlorGaus --> 7

  // pitch 20, model Lor --> 16
  // pitch 20, model Gaus --> 17
  // pitch 20, model LorGaus --> 18
  // pitch 20, model LorlorGaus --> 19

  // pitch 30, model Lor --> 32
  // pitch 30, model Gaus --> 33
  // pitch 30, model LorGaus --> 34
  // pitch 30, model LorlorGaus --> 35

  // pitch 40, model Lor --> 44
  // pitch 40, model Gaus --> 45
  // pitch 40, model LorGaus --> 46
  // pitch 40, model LorlorGaus --> 47



  //myDIGMAPS2.PlotAConfiguration(9,0);
  ...
  Int_t pitch = 10;
  if((myconfig>=0)&&(myconfig<=9)){
    sprintf(ResultFileName,"/rawcmos7/abesson/ILCSOFT/DIGITISEUR/data/run%dPl%d_ClCharge.root",18524,9);
    pitch = 10;
  }else if((myconfig>=10)&&(myconfig<=19)){
    sprintf(ResultFileName,"/rawcmos7/abesson/ILCSOFT/DIGITISEUR/data/run%dPl%d_ClCharge.root",9552,9);
    pitch = 20;
  }elseif((myconfig>=20)&&(myconfig<=29)){
    sprintf(ResultFileName,"/rawcmos7/abesson/ILCSOFT/DIGITISEUR/data/run%dPl%d_ClCharge.root",9553,10);
    pitch = 30;
  }else{
    sprintf(ResultFileName,"/rawcmos7/abesson/ILCSOFT/DIGITISEUR/data/run%dPl%d_ClCharge.root",9552,10);
    pitch = 40;
  }
  ...
  Float_t hYmax = 0.35;
  MainCanvas1->cd(1);
  integg = hmult_ADC_1->Integral();
  if(integg!=0.0){hmult_ADC_1->Scale(1/integg);}
  hmult_ADC_1->SetLineColor(2);
  ...
  hmult_ADC_1->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_1->Draw("sames");
  MainCanvas1_1->Update();
  TPaveStats *statdata1_1 = (TPaveStats*)hmult_ADC_1->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(2);
  integg = hmult_ADC_2->Integral();
  if(integg!=0.0){hmult_ADC_2->Scale(1/integg);}
  hmult_ADC_2->SetLineColor(2);
  ...
  hmult_ADC_2->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_2->Draw("sames");
  MainCanvas1_2->Update();
  TPaveStats *statdata1_2 = (TPaveStats*)hmult_ADC_2->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(3);
  integg = hmult_ADC_3->Integral();
  if(integg!=0.0){hmult_ADC_3->Scale(1/integg);}
  hmult_ADC_3->SetLineColor(2);
  ...
  hmult_ADC_3->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_3->Draw("sames");
  MainCanvas1_3->Update();
  TPaveStats *statdata1_3 = (TPaveStats*)hmult_ADC_3->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(4);
  integg = hmult_ADC_4->Integral();
  if(integg!=0.0){hmult_ADC_4->Scale(1/integg);}
  hmult_ADC_4->SetLineColor(2);
  ...
  hmult_ADC_4->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_4->Draw("sames");
  MainCanvas1_4->Update();
  TPaveStats *statdata1_4 = (TPaveStats*)hmult_ADC_4->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(5);
  integg = hmult_ADC_5->Integral();
  if(integg!=0.0){hmult_ADC_5->Scale(1/integg);}
  hmult_ADC_5->SetLineColor(2);
  ...
  hmult_ADC_5->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_5->Draw("sames");
  MainCanvas1_5->Update();
  TPaveStats *statdata1_5 = (TPaveStats*)hmult_ADC_5->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(6);
  integg = hmult_ADC_6->Integral();
  if(integg!=0.0){hmult_ADC_6->Scale(1/integg);}
  hmult_ADC_6->SetLineColor(2);
  ...
  hmult_ADC_6->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_6->Draw("sames");
  MainCanvas1_6->Update();
  TPaveStats *statdata1_6 = (TPaveStats*)hmult_ADC_6->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(7);
  integg = hmult_ADC_7->Integral();
  if(integg!=0.0){hmult_ADC_7->Scale(1/integg);}
  hmult_ADC_7->SetLineColor(2);
  ...
  hmult_ADC_7->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_7->Draw("sames");
  MainCanvas1_7->Update();
  TPaveStats *statdata1_7 = (TPaveStats*)hmult_ADC_7->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(8);
  integg = hmult_ADC_8->Integral();
  if(integg!=0.0){hmult_ADC_8->Scale(1/integg);}
  hmult_ADC_8->SetLineColor(2);
  ...
  hmult_ADC_8->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_8->Draw("sames");
  MainCanvas1_8->Update();
  TPaveStats *statdata1_8 = (TPaveStats*)hmult_ADC_8->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(9);
  integg = hmult_ADC_9->Integral();
  if(integg!=0.0){hmult_ADC_9->Scale(1/integg);}
  hmult_ADC_9->SetLineColor(2);
  ...
  hmult_ADC_9->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_9->Draw("sames");
  MainCanvas1_9->Update();
  TPaveStats *statdata1_9 = (TPaveStats*)hmult_ADC_9->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas1->cd(10);
  integg = hmult_ADC_10->Integral();
  if(integg!=0.0){hmult_ADC_10->Scale(1/integg);}
  hmult_ADC_10->SetLineColor(2);
  ...
  hmult_ADC_10->SetAxisRange(0,hYmax,"Y");
  hmult_ADC_10->Draw("sames");
  MainCanvas1_10->Update();
  TPaveStats *statdata1_10 = (TPaveStats*)hmult_ADC_10->GetListOfFunctions()->FindObject("stats");
  ...
  TPaveStats *statdata = (TPaveStats*)hqcn_adc1->GetListOfFunctions()->FindObject("stats");
  ...
  */
  ...
  hqcn_adc25->Draw("sames");
  hqcn_adc25->Fit("landau","","same");
  hqcn_adc25->GetFunction("landau")->SetLineColor(2);
  hqcn_adc25->GetFunction("landau")->SetLineStyle(2);
  MainCanvas2_2->Update();
  //hqcn_adc25->GetFunction("landau")->Draw("same");
  TPaveStats *statdata2 = (TPaveStats*)hqcn_adc25->GetListOfFunctions()->FindObject("stats");
  ...
  //-----------------------------------------
  MainCanvas3->cd(5);
  integg = hGOODCharge_Seed_over_total->Integral();
  if(integg!=0.0){hGOODCharge_Seed_over_total->Scale(1/integg);}
  hGOODCharge_Seed_over_total->SetLineColor(2);
  ...
  hGOODCharge_Seed_over_total->SetAxisRange(0,0.3,"Y");
  hGOODCharge_Seed_over_total->Draw("sames");
  MainCanvas3_1->Update();
  TPaveStats *statdata3_1 = (TPaveStats*)hGOODCharge_Seed_over_total->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas3->cd(6);
  integg = hGOODCharge_Crown1_over_total->Integral();
  if(integg!=0.0){hGOODCharge_Crown1_over_total->Scale(1/integg);}
  hGOODCharge_Crown1_over_total->SetLineColor(2);
  ...
  hGOODCharge_Crown1_over_total->SetAxisRange(0,0.3,"Y");
  hGOODCharge_Crown1_over_total->Draw("sames");
  MainCanvas3_2->Update();
  TPaveStats *statdata3_2 = (TPaveStats*)hGOODCharge_Crown1_over_total->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas3->cd(7);
  integg = hGOODCharge_Crown2_over_total->Integral();
  if(integg!=0.0){hGOODCharge_Crown2_over_total->Scale(1/integg);}
  hGOODCharge_Crown2_over_total->SetLineColor(2);
  ...
  hGOODCharge_Crown2_over_total->SetAxisRange(0,0.3,"Y");
  hGOODCharge_Crown2_over_total->Draw("sames");
  MainCanvas3_3->Update();
  TPaveStats *statdata3_3 = (TPaveStats*)hGOODCharge_Crown2_over_total->GetListOfFunctions()->FindObject("stats");
  ...
  MainCanvas3->cd(8);
  integg = hGOODCharge_4neighbours_over_total->Integral();
  if(integg!=0.0){hGOODCharge_4neighbours_over_total->Scale(1/integg);}
  hGOODCharge_4neighbours_over_total->SetLineColor(2);
  ...
  hGOODCharge_4neighbours_over_total->Draw("sames");
  MainCanvas3_4->Update();
  TPaveStats *statdata3_4 = (TPaveStats*)hGOODCharge_4neighbours_over_total->GetListOfFunctions()->FindObject("stats");
...
//sprintf(HeaderSave,"resolution_%d_%d.gif",RunNumber,ThePlaneNumber);
  if(boolprint==true){
  sprintf(HeaderSave,"Mulitiplicity1_pitch%d.gif",pitch);
  MainCanvas1->Print(HeaderSave,"gif");
  sprintf(HeaderSave,"Mulitiplicity1_pitch%d.eps",pitch);
  MainCanvas1->Print(HeaderSave,"eps");
  sprintf(HeaderSave,"Mulitiplicity2_pitch%d.gif",pitch);
  MainCanvas2->Print(HeaderSave,"gif");
  sprintf(HeaderSave,"Mulitiplicity2_pitch%d.eps",pitch);
  MainCanvas2->Print(HeaderSave,"eps");
  sprintf(HeaderSave,"Mulitiplicity3_pitch%d.gif",pitch);
  MainCanvas3->Print(HeaderSave,"gif");
  sprintf(HeaderSave,"Mulitiplicity3_pitch%d.eps",pitch);
  MainCanvas3->Print(HeaderSave,"eps");
  sprintf(HeaderSave,"Mulitiplicity4_pitch%d.gif",pitch);
  MainCanvas4->Print(HeaderSave,"gif");
  sprintf(HeaderSave,"Mulitiplicity4_pitch%d.eps",pitch);
