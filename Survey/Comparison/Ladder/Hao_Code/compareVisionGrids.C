...
void compareVisionGrids(char* input = "grid_08_16.txt")
{
  ifstream ifs(input);
  int nMeasurements = 0;
  string line;
  ...
  grMeasurement->SetTitle("visionGrids");
  grMeasurement->Draw("surf1");
  grMeasurement->Draw("cont4z");
  c1->SaveAs("visionGrids.gif");
  ...
  grZDiff->SetTitle("visionGridsZDiff");
  grZDiff->Draw("cont4z");
  c1->SaveAs("visionGridsZDiff.gif");

  hDiff->Draw();
  hDiff->SetTitle("visionGridsZDiff1D");
  hDiff->Fit("gaus", "l");
  c1->SaveAs("visionGridsZDiff1D.gif");

  TF2* plane = new TF2("plane", "[0]+[1]*x+[2]*y", 0,21,0,23);
  plane->SetTitle("visionGridsZDiffPlane");
  grZDiff->Fit(plane);
  plane->Draw("cont4z");
  c1->SaveAs("visionGridsZDiffPlane.gif");
  ...
  grZDiff2->SetTitle("visionGridsZDiffSubtractPlane");
  grZDiff2->Draw("cont4z");
  c1->SaveAs("visionGridsZDiffSubtractPlane.gif");
  
  hDiff1->SetTitle("visionGridsZDiffSubtractPlane1D");
  hDiff1->Draw();
  hDiff1->Fit("gaus", "l");
  c1->SaveAs("visionGridsZDiffSubtractPlane1D.gif");
